...
echo   - Apply local overlays: electron 44.3.0, npmMinimalAgeGate, npmRebuild,
echo     tray icons, pnpm.mjs patch
...
rem pause
echo.
pwsh -NoProfile -ExecutionPolicy Bypass -File "%~dp0build.ps1" -Target package-dir -SkipSubmodule
